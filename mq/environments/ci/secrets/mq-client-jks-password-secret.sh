...
# Set variables
KEY_STORE_PASSWORD=${KEY_STORE_PASSWORD:-mqclientcp4i}
...
kubeseal -n cp4i --controller-name=${SEALED_SECRET_CONTOLLER_NAME} --controller-namespace=${SEALED_SECRET_NAMESPACE} -o yaml < delete-mq-client-jks-password-secret.yaml > mq-client-jks-password-secret.yaml
